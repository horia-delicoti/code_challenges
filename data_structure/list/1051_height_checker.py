...
# Time Complexity: O(n log n), where n is the length of the heights array due to sorting.
# Space Complexity: O(n), where n is the length of the heights array due to the creation of the expected array.